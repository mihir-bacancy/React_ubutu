/**
 * @providesModule UploadTutorAttemptPlay
 */
...
export default class UploadTutorAttemptPlay extends Component {
    ...
    _updateOrientation = (specificOrientation) => {
        (specificOrientation == 'LANDSCAPE-LEFT' || specificOrientation == 'LANDSCAPE-RIGHT' || specificOrientation == 'PORTRAITUPSIDEDOWN') ? this.setState({orientation: 'LANDSCAPE'}) : this.setState({orientation: 'PORTRAIT'});
    }
